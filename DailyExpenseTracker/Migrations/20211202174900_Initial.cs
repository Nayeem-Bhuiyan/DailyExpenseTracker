...
namespace DailyExpenseTracker.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ExpenseDetails = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyExpense_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DailyExpense_Category_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyExpense_ApplicationUserId",
                table: "DailyExpense",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_DailyExpense_CategoryId",
                table: "DailyExpense",
                column: "CategoryId");
        }
